        ...
        >
          <table>
            ...
            {items?.locations?.data ? (
              <tbody>
                {items.locations.data.length > 0 ? (
                  <>
                    {items.locations.data.map((item, index) => {
                      return (
                        <tr
                          key={index}
